...
const Footer = () => {
    return (
        <footer className='footer footer-center mt-16 gap-4 border-t-2 bg-white p-5 md:gap-10 md:p-10  dark:bg-black '>
            <aside>
                <Link
                    to={'/'}
                ...
                <p className='font-bold'>Providing beautiful art since 1999</p>
